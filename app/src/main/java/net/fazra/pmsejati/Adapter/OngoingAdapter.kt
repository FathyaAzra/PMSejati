package net.fazra.pmsejati.Adapter
...
class OngoingAdapter(private val items: List<OngoingDomain>):RecyclerView.Adapter<OngoingAdapter.Viewholder>() {
    inner class Viewholder(itemView: View):RecyclerView.ViewHolder(itemView){
        ...
        val progressText:TextView=itemView.findViewById(R.id.progressTxt)
        ...
        fun setTextColor(colorRes:Int){
            ...
            pic.setColorFilter(ContextCompat.getColor(itemView.context, colorRes))
        }
    }
